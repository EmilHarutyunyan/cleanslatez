...
import medicalImg from '../../../public/assets/images/medical-debt.png';
import hospitalImg from '../../../public/assets/images/hospital-debt.png'
		...
		<section className={"container"}>
            <div className={classes.main}>
                <div className={classes.left}>
                    <Image className={classes.img} src={medicalImg} alt={"medical debt"}/>
                </div>
            ...
            <div className={classes.below}>
                <div className={classes.left}>
                    <Image className={classes.imageStyle} src={hospitalImg} alt={"hospital debt forgiveness"}/>
                </div>
                <div className={classes.right}>
