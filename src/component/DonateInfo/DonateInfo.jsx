...
import billImg from '../../../public/assets/images/medical-bill-grants.png';
import charityImg from '../../../public/assets/images/charity-help.png';
		...
		<section className={"container"}>
            ...
            <div className={classes.main}>
                <div className={classes.left}>
                    <Image className={classes.imgStyle} src={billImg} alt={"medical bill grants"}/>
                </div>
            ...
            <div className={classes.main}>
                <div className={classes.left}>
                    <Image className={classes.imgStyle} src={charityImg} alt={"charity help for medical bills"}/>
                </div>
                <div className={classes.right}>
